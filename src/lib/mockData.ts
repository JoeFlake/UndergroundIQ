...
export const mockProjects: Project[] = [
  ...
  { id: 'proj-3', name: 'Historic Building Restoration', status: 'Inactive', userId: 'bypass-user-id' },
  { id: 'proj-4', name: 'Highway Overpass Construction', status: 'Active', userId: 'bypass-user-id' },
];
